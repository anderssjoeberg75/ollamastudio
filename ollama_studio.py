...
# Delas med webbversionen via catalog.py (enda källan) så listorna inte tyst
# glider isär (board #8). Saknas filen används en liten inbäddad reservlista
# så skrivbordsappen fortfarande fungerar fristående. Storlekar är ungefärliga.
# --------------------------------------------------------------------------
try:
